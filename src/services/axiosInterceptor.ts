...
axiosApiInstance.interceptors.request.use(
  (config: any) => {
    config.headers = {
      // TODO: we have to add this api key inside of env file
      authorization: `apikey 2hpyBqqhXtU50I7XDjbWbV:1zZZYTOfYhag9CGwMuTHK2`,
...
axiosApiInstance.interceptors.response.use(
  ...
  async function (error: any) {
    ...
    // 401 --> (Refresh_token)
      ...
      window.location.href = appRoutes.HOME_PAGE;
